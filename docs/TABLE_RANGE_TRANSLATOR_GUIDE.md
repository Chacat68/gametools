...
表范围翻译提取器是一个智能的多语言内容提取工具，根据字段导出的JSON配置文件，自动识别和提取Excel表格中需要翻译的内容，并生成统一的翻译总表。
...
✅ **多语言识别**
- 支持中文、越南文、泰文识别
- 自动分类语言类型（中文、越南文、泰文、混合等）
- 跳过纯英文内容

✅ **翻译总表生成**
- 每个表格文件对应一个工作表标签
- 统一的列格式：字段名 | 字段类型 | ID | 行号 | 中文内容 | 越南文 | 泰文 | 语言类型
- 美观的表格样式，带边框和冻结首行
